...
class Intro extends Component {
  render() {
    return (
      <Section tier={3} id={'dsa-national-convention-delegates'}>
        <h1>DSA National Convention Delegates</h1>
        ...
        <p>{"Meditation minim knausgaard chicharrones velit nesciunt. Austin tumblr skateboard voluptate. Cray bespoke deserunt, listicle aliqua accusamus lyft reprehenderit craft beer nihil next level chicharrones quis. Ex cronut enamel pin godard, taiyaki pork belly vape jianbing echo park assumenda art party austin. Dolore pour-over activated charcoal cloud bread lumbersexual. Polaroid mlkshk blog, quis taxidermy enim twee humblebrag. Tote bag 3 wolf moon viral portland copper mug."}</p>
      </Section>
    );
  }
}
